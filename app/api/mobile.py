...
def update_driver_location():
    ...
    try:
        ...
        try:
            ...
            socketio.emit('driver_location_update', location_update, 
...
def update_driver_status():
    ...
    try:
        ...
        valid_statuses = ['available', 'busy', 'en_route', 'delivering', 'break', 'offline']
        ...
        try:
            from app import socketio
            socketio.emit('driver_status_update', status_update, 
                         room='dispatch')
        except:
            pass
...
def sync_offline_data():
    ...
    try:
        ...
        logger.info(f"Offline sync for {device_id}: {sync_results['processed']} processed, {sync_results['failed']} failed")
...
def _compress_route_for_mobile(route_data: Dict[str, Any], preferences: Dict[str, Any]) -> Dict[str, Any]:
    """
