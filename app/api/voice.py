...
def voice_commit():
    ...
    try:
        ...
        return error_response(
            message="Failed to process voice commit", status_code=500
        )
...
def save_voice_note():
    ...
    try:
        ...
        return success_response(
            data=result, message="Voice note saved successfully"
        )
        ...
        return error_response(
            message="Failed to save voice note", status_code=500
        )
...
def upload_voice_audio():
    ...
    try:
        ...
        return success_response(
            data=result, message="Audio file uploaded successfully"
        )
        ...
        return error_response(
            message="Failed to upload audio file", status_code=500
        )
...
def _extract_auto_tags(text: str) -> List[str]:
    ...
    if any(word in text_lower for word in ["bug", "fix", "error", "issue"]):
        tags.append("#bug")
    if any(
        word in text_lower for word in ["feature", "add", "new", "implement"]
    ):
        tags.append("#feature")
