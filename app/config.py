...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'sqlite:///routeforce.db'
    ...
    MAX_ROUTE_OPTIMIZATION_TIME = int(os.environ.get('MAX_ROUTE_OPTIMIZATION_TIME', '300'))
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'sqlite:///routeforce_dev.db'
...
class ProductionConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'postgresql://localhost/routeforce_prod'
