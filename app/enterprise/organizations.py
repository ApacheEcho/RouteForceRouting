...
class User:
    ...
    def _get_default_permissions(self) -> List[str]:
        ...
        role_permissions = {
            ...
            'admin': ['view_routes', 'create_routes', 'optimize_routes', 'manage_users', 'view_analytics'],
...
class OrganizationManager:
    ...
    def get_organization_stats(self, org_id: str) -> Dict:
        ...
        user_count = len([u for u in self.users.values() if u.organization_id == org_id])
...
def get_organization_by_subdomain(subdomain):
    ...
    try:
        ...
        return jsonify({
            ...
            'plan': org.plan,
            'settings': {
                'analytics_enabled': org.settings.get('analytics_enabled', False),
                'real_time_tracking': org.settings.get('real_time_tracking', False)
            }
        }), 200
