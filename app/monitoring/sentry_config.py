"""
Sentry configuration for RouteForce Routing.
Provides error tracking and performance monitoring hooks.
"""
...
# Celery is optional for the core application. Import the integration
# defensively so tests and environments without Celery don't error.
try:  # pragma: no cover - integration availability varies
    from sentry_sdk.integrations.celery import CeleryIntegration
except Exception:  # Celery not installed
    CeleryIntegration = None  # type: ignore[misc]
...
def init_sentry(app: Flask = None):
    ...
    try:
        ...
        # Build integrations list without requiring Celery at import time
        integrations = [
        ...
        if CeleryIntegration is not None:  # pragma: no branch
            integrations.insert(3, CeleryIntegration())
