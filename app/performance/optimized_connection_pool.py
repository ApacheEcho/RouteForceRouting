...
class OptimizedConnectionPool:
    ...
    def __init__(
        ...
        logger.info(
            f"Initialized OptimizedConnectionPool: {min_connections}-{max_connections} connections"
        )
    ...
    def _create_engine(self) -> sa.Engine:
        ...
        engine = create_engine(
            self.database_url, **pool_kwargs, **engine_kwargs
        )
