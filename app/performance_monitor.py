...
class PerformanceMonitor:
    ...
    def __init__(self, metrics_retention_hours: int = 24):
        ...
        self.thresholds = {
            ...
            'api_response_time': {'warning': 1000.0, 'critical': 5000.0},  # milliseconds
    ...
    def _initialize_metrics_storage(self):
        ...
        metric_types = [
            ...
            'api_response_time', 'database_connections', 'error_rate',
            'active_routes', 'analytics_requests', 'prediction_accuracy'
        ]
        
        for metric_type in metric_types:
            self.metrics_history[metric_type] = deque(maxlen=self.metrics_retention_hours * 60)  # 1 metric per minute
    ...
    def _add_metric(self, metric_type: str, value: float, unit: str, timestamp: str):
        ...
        logger.debug(f"Metric collected: {metric_type}={value:.2f}{unit} ({metric.status})")
    ...
    def _generate_alert(self, metric: PerformanceMetric):
        ...
        for alert in self.active_alerts:
            if (alert.component == 'system' and 
                alert.metric == metric.metric_type and 
    ...
    def get_metrics_history(self, metric_type: str, hours: int = 1) -> List[Dict[str, Any]]:
    ...
    def get_system_health_score(self) -> Dict[str, Any]:
        ...
        score = (normal_count * 100 + warning_count * 60 + critical_count * 20) / total_metrics
