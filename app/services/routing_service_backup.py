...
class RoutingService:
    ...
    def cluster_stores_by_proximity(self, stores: List[Dict], radius_km: float = 2.0) -> List[List[Dict]]:
        """
    ...
    def _save_route_to_db(self, route: List[Dict[str, Any]], filters: Dict[str, Any], metrics: RoutingMetrics):
