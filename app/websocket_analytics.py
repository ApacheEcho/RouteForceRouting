    ...
    def handle_live_analytics_request(data):
        ...
        try:
            ...
            emit('analytics_update', {
                ...
                'trends': [trend.__dict__ if hasattr(trend, '__dict__') else trend for trend in trends],
...
def broadcast_analytics_insights(socketio, insight_data):
    ...
    socketio.emit('analytics_insight', {
        'type': 'new_insight',
        'data': insight_data,
        'timestamp': datetime.now().isoformat()
    })
...
def broadcast_performance_alert(socketio, alert_data):
    ...
    socketio.emit('performance_alert', {
