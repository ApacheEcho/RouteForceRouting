    ...
    def _init_roles(self):
        ...
        roles = [
            ...
            Role(
                ...
                permissions=[
                    "routes.view", "routes.create", "routes.edit", "routes.optimize",
                    "analytics.view"
                ],
                is_system_role=True
            ),
            Role(
                ...
                permissions=[
                    "routes.view", "routes.create", "routes.edit", "routes.optimize", "routes.export",
            ...
            Role(
                ...
                permissions=[
                    "routes.*", "analytics.*", "users.view", "users.create", 
                    "users.edit", "org.view", "org.edit", "org.settings"
                ],
                is_system_role=True
            ),
            Role(
