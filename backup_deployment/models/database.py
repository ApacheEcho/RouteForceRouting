...
class Store(db.Model):
    ...
    is_active = db.Column(db.Boolean, default=True)
    store_metadata = db.Column(db.Text, nullable=True)  # JSON string for additional data
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class Route(db.Model):
    ...
    status = db.Column(db.String(20), default='generated')  # generated, in_progress, completed
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class Analytics(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    event_type = db.Column(db.String(50), nullable=False)  # route_generated, user_login, etc.
