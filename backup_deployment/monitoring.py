...
class MetricsCollector:
    ...
    def record_request(self, endpoint: str, response_time: float, status_code: int, user_ip: str):
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            return {
                ...
                'memory_usage_mb': list(self.metrics['memory_usage'])[-10:],  # Last 10 readings
                'cpu_usage_percent': list(self.metrics['cpu_usage'])[-10:],   # Last 10 readings
