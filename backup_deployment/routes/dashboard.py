        ...
        for algo in algorithms:
            try:
                ...
                if metrics and metrics.algorithm_metrics:
                    result['improvement_percent'] = metrics.algorithm_metrics.get('improvement_percent', 0)
                    result['initial_distance'] = metrics.algorithm_metrics.get('initial_distance', 0)
                    result['final_distance'] = metrics.algorithm_metrics.get('final_distance', 0)
                else:
        ...
        algorithm_info = {
            ...
            'simulated_annealing': {
                ...
                'parameters': {
                    ...
                    'cooling_schedule': {'default': 'exponential', 'options': ['exponential', 'linear', 'logarithmic']},
                    'neighborhood_operator': {'default': 'swap', 'options': ['swap', 'insert', 'reverse', 'mixed']}
                },
                'performance': {
            ...
            'multi_objective': {
                ...
                'parameters': {
                    'objectives': {'default': 'distance,time', 'options': ['distance', 'time', 'priority', 'fuel_cost']},
                    'population_size': {'default': 100, 'range': [20, 500]},
            ...
            'default': {
                ...
                'parameters': {
                    'optimization_level': {'default': 'medium', 'options': ['low', 'medium', 'high']}
                },
                'performance': {
                    'avg_improvement': '0%',
