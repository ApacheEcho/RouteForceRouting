    ...
    try:
                    ...
                    jsonify(
                        {
                            ...
                            "details": [
                                "The uploaded file exceeds the maximum size limit of 16MB."
                            ],
                        }
                    ),
                    413,
        ...
        try:
            ...
            route_result = routing_service.generate_route_with_filters(
                file_path=file_path, filters=route_request.get_filters()
            )
            ...
            response_data = {
                ...
                "metrics": {
                    ...
                    "optimization_score": (
                        routing_service.metrics.optimization_score
                        if routing_service.metrics
                        else 0
                    ),
                    "processing_time": (
                        routing_service.metrics.processing_time
                        if routing_service.metrics
                        else 0
                    ),
                },
    ...
    try:
        ...
        try:
            ...
            if use_proximity:
                ...
                logger.info(
                    f"Created {len(clusters)} clusters with radius {radius_km}km"
                )
            ...
            route_result = routing_service.generate_route_with_filters(
                file_path=file_path, filters=filters
            )

            # Calculate metrics
            optimization_score = routing_service.calculate_optimization_score(
                route_result
            )
