...
class DatabaseService:
    ...
    def get_routes_by_user(user_id: int, limit: int = 10) -> List[Route]:
        ...
        return Route.query.filter_by(user_id=user_id)\
    ...
    def get_performance_metrics() -> Dict[str, Any]:
        ...
        try:
            ...
            # Most used algorithm
            most_used_algorithm = db.session.query(
            ...
            return {
                'avg_optimization_time': float(avg_optimization_time) if avg_optimization_time else 0,
                'total_routes': total_routes,
                'avg_improvement_score': float(avg_improvement) if avg_improvement else 0,
                'most_used_algorithm': most_used_algorithm[0] if most_used_algorithm else None
            }
    ...
    @staticmethod
    def bulk_create_stores(stores_data: List[Dict[str, Any]], user_id: Optional[int] = None) -> List[Store]:
