...
def main():
    ...
    try:
        ...
        print('| Test | Mean Time (s) | Min Time (s) | Max Time (s) | Status |')
        print('|------|---------------|--------------|--------------|--------|')
        
        for benchmark in benchmarks:
            name = benchmark.get('name', 'Unknown').replace('test_', '').replace('_performance', '')
            ...
            print(f'| {name} | {mean:.4f} | {min_time:.4f} | {max_time:.4f} | {status} |')
