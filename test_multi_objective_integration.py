...
def test_multi_objective_api():
    ...
    stores = [
        {"id": 1, "name": "Store A", "lat": 40.7128, "lon": -74.0060, "priority": 1, "demand": 50},
        {"id": 2, "name": "Store B", "lat": 40.7589, "lon": -73.9851, "priority": 2, "demand": 30},
        {"id": 3, "name": "Store C", "lat": 40.7282, "lon": -73.7949, "priority": 3, "demand": 40},
        {"id": 4, "name": "Store D", "lat": 40.6782, "lon": -73.9442, "priority": 1, "demand": 60},
        {"id": 5, "name": "Store E", "lat": 40.7505, "lon": -73.9934, "priority": 2, "demand": 25},
        {"id": 6, "name": "Store F", "lat": 40.7831, "lon": -73.9712, "priority": 3, "demand": 35},
        {"id": 7, "name": "Store G", "lat": 40.7061, "lon": -74.0087, "priority": 1, "demand": 45},
        {"id": 8, "name": "Store H", "lat": 40.7614, "lon": -73.9776, "priority": 2, "demand": 55}
    ]
    ...
    if successful_tests > 0:
        avg_api_time = sum(r['api_time'] for r in results if r['success']) / successful_tests
        ...
        print(f"Best Pareto front size: {best_result['metrics'].get('pareto_front_size', 0)} "
