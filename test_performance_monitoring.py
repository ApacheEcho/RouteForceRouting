    ...
    def test_monitoring_start(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"✗ Monitoring start request failed: {response.status_code}")
                return False
    ...
    def test_current_metrics(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"✗ Current metrics request failed: {response.status_code}")
                return False
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if history_data.get('success'):
                    ...
                    logger.info(f"  Metric type: {history_data.get('metric_type', 'unknown')}")
                    
                    if history:
                        latest = history[-1]
                        logger.info(f"  Latest value: {latest.get('value', 0):.1f}{latest.get('unit', '')}")
                ...
                logger.error(f"✗ Metrics history request failed: {response.status_code}")
                return False
    ...
    def test_performance_summary(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(f"✗ Performance summary request failed: {response.status_code}")
                return False
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if info_data.get('success'):
                    ...
                    logger.info(f"  Process Count: {system_info.get('process_count', 0)}")
